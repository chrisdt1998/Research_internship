...
# from timesformer.models.vit_LRP import TimeSformer
# from timesformer.models.ViT_explanation_generator import LRP
import os
import numpy as np
import cv2
...
class AttnExtract():
    ...
    def generate_visualization(self, original_image, class_index=None, inc_temporal=False):
        transformer_attribution, pred_label = self.generate_relevance(original_image.cuda(), index=class_index, inc_temporal=inc_temporal, detach=False)
    ...
    def extract_rollout(self, test_file):
        ...
        for t in ['rollout_grad']:
            ...
            self.dump_pickle('CREMA_D/Pickle dump/Rollout', t + '_vis', output_vis)
            self.dump_pickle('CREMA_D/Pickle dump/Rollout', t + '_labels', output_labels)
